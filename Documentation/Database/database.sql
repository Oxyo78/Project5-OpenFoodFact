...
CREATE TABLE IF NOT EXISTS `DBOpenFoodFacts`.`Saved` (
  ...
  `sav_cat_id` INT UNSIGNED NOT NULL,
  `sav_nutriscore` INT NOT NULL,
  INDEX `fk_sav_user_id_idx` (`sav_user_id` ASC),
  PRIMARY KEY (`sav_id`),
  INDEX `fk_Saved_Categories1_idx` (`sav_cat_id` ASC),
  CONSTRAINT `fk_sav_user_id`
    FOREIGN KEY (`sav_user_id`)
    REFERENCES `DBOpenFoodFacts`.`User` (`User_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Saved_Categories1`
